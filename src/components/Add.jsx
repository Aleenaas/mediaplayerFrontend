  ...
  const handleAdd = async()=>{
    ...
    if(!caption || !Imgurl || !emdedLink){
      toast.info('please fill the form completely')
       ...
       // https://youtu.be/M-yqIcuVNe8?si=hBU6gl_76QSeeCuA
      ...
      <Modal show={show} onHide={handleClose}> 
        ...
        <Modal.Body>
            ...
            <form className='border border-secondary p-3 rounded'>
               <div className='mb-3'> 
                <input type="text" value={videoDetails.caption} placeholder='Video Capation ' className='form-control' onChange={(e)=>setVideoDetails({...videoDetails,caption:e.target.value})}/>
                </div >
                <div className='mb-3'>
